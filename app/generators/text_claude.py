...
class BlogDraftGenerator(Generator):
    ...
    def generate(self, tenant: Tenant, asset: Asset,
        ...
        prompt = (
            ...
            + "[읽는 사람 시점 — 제목·첫문단 필수]\n"
              "이 글을 읽는 사람은 우리 가게의 '손님'이다. 가게가 하는 일(판매·시공·납품·검수·매입)이 아니라 "
              "손님이 하는 일(구매·구입·고르기·맡기기·의뢰) 관점으로 써라.\n"
              "나쁜 예: '중고차판매 가격 걱정?'(파는 쪽 시점) → 좋은 예: '중고차 구매 가격 걱정?'\n"
              "★ 사전에 없는 조어를 만들지 마라 — '검수기·시공기·판매기' 같은 말은 아무도 안 쓴다. "
              "손님이 실제로 입에 올리는 말만 써라(직접 확인·검수 과정·둘러보기 같은 자연스러운 표현).\n"
              "★ '후기'는 손님이 쓴 경험담을 뜻한다. 가게가 자기 매물을 소개하는 글에는 쓰지 마라.\n"
            + "[감점 방지 — 반드시 지켜라]\n"
