...
<section id="demo" class="bg-[#F9FAFB] py-20"><div class="max-w-3xl mx-auto px-5">
 <div class="bg-white border-2 border-indigo-200 rounded-2xl shadow-sm p-6 sm:p-8 text-left">
  ...
  <form id="demoForm" class="space-y-3">
   <label class="block bg-slate-50 border-2 border-dashed border-slate-200 rounded-xl px-4 py-5 text-center cursor-pointer hover:border-indigo-300 transition">
     <span class="text-slate-800 font-bold inline-flex items-center gap-2">{_icon('camera', 'w-5 h-5 text-indigo-600')} 사진 올리기</span>
     <span class="block text-slate-400 text-xs mt-1">가게·상품 사진 (여러 장 가능 · 선택)</span>
   ...
   <div class="flex gap-2 text-sm">
     <label class="flex-1"><input type="radio" name="d_biz" value="local" checked class="peer hidden"><div class="text-center py-3 rounded-xl bg-white border border-slate-200 text-slate-500 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 font-bold cursor-pointer transition">동네 매장</div></label>
     <label class="flex-1"><input type="radio" name="d_biz" value="seller" class="peer hidden"><div class="text-center py-3 rounded-xl bg-white border border-slate-200 text-slate-500 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 font-bold cursor-pointer transition">온라인 셀러</div></label>
   </div>
   <button class="w-full py-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-lg transition">실제로 만들어보기</button></form>
  <div id="demoResult" class="mt-5"></div>
  <p class="text-center text-slate-400 text-xs mt-3">가입 없이 미리보기 · 가입하면 <b class="text-slate-600">5채널 전부 + 영상</b> 무료 2회</p>
 </div></div></section>"""
...
def _modes() -> str:
    ...
    return ("<section class='py-24'><div class='max-w-5xl mx-auto px-5'>"
...
<section class="bg-white py-24">
 <div class="max-w-6xl mx-auto px-5">
  <div class="text-center mb-4"><span class="reveal inline-block px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-xs font-bold text-slate-500">2026 최신 알고리즘 반영</span></div>
...
<section class="bg-white py-24">
 <div class="max-w-5xl mx-auto px-5">
  ...
  <div class="grid sm:grid-cols-2 gap-5">
   <div class="reveal rounded-2xl p-6 bg-slate-50 border border-slate-200">
