...
def info_prompt(tenant, industry: str, region: str, kw: str, angle: str,
                note: str, n_imgs: int, trust: str = "") -> str:
    ...
    return (
        ...
        "e. 비교는 마크다운 표(| 항목 | A | B |), 절차는 번호 리스트(1. 2. 3.), 핵심 정리는 불릿(-)로.\n"
...
def geo_gate(payload: dict) -> dict:
    """트랙 B 산출물 GEO 구조 게이트. {passed, checks{G1..G5}, fails[]}.
    G1 소제목 질문형 100% / G2 각 H2 첫 문장 완결 평서문 / G3 수치 3개+ / G4 FAQ·요약 존재 / G5 단락 400자 이하."""
